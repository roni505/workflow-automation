...
export default function TriggerBtn({
  ...
  return (
    <div
      className={`relative h-${h} w-${w} overflow-hidden bg-neutral-800 p-px`}
    >
      ...
      <div
        ...
        className="absolute inset-0 z-50 flex cursor-pointer items-center justify-center gap-1.5 rounded-sm"
      >
